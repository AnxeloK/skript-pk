...
public abstract class GeneratedAvatarAbility extends AvatarAbility implements GeneratedAbility {

    private final AbilityExecutor executor = new AbilityExecutor(this);

    protected GeneratedAvatarAbility() {
        super(null);
        executor.initializePrototype();
    }

    protected GeneratedAvatarAbility(Player player) {
        super(player);
