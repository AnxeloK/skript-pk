...
public abstract class GeneratedAirAbility extends AirAbility implements GeneratedAbility {

    private final AbilityExecutor executor = new AbilityExecutor(this);

    protected GeneratedAirAbility() {
        super(null);
        executor.initializePrototype();
    }

    protected GeneratedAirAbility(Player player) {
        super(player);
