...
public abstract class GeneratedChiAbility extends ChiAbility implements GeneratedAbility {

    private final AbilityExecutor executor = new AbilityExecutor(this);

    protected GeneratedChiAbility() {
        super(null);
        executor.initializePrototype();
    }

    protected GeneratedChiAbility(Player player) {
        super(player);
