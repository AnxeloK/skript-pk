...
public abstract class GeneratedWaterAbility extends WaterAbility implements GeneratedAbility {

    private final AbilityExecutor executor = new AbilityExecutor(this);

    protected GeneratedWaterAbility() {
        super(null);
        executor.initializePrototype();
    }

    protected GeneratedWaterAbility(Player player) {
        super(player);
