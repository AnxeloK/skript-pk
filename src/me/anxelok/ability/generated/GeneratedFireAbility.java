...
public abstract class GeneratedFireAbility extends FireAbility implements GeneratedAbility {

    private final AbilityExecutor executor = new AbilityExecutor(this);

    protected GeneratedFireAbility() {
        super(null);
        executor.initializePrototype();
    }

    protected GeneratedFireAbility(Player player) {
        super(player);
